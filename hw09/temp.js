ttps://docs.google.com/spreadshe!/usr/bin/env node
 ...
 * @see https://docs.google.com/spreadsheets/d/1BxiMVs0XRA5nFMdKvBdBZjgmUUqptlb$
...
function recordTemp(auth) {
  ...
  fs.readFile('/sys/class/i2c-adapter/i2c-2/2-0049/hwmon/hwmon0/temp1_input', ($
      if (err) return console.log('Error loading client secret file:', err);
      ...
      if(temp !== tempOld) {
          ...
          resource: {
            values: [   // getTime returs ms.  Convert to days.  25569 is date($
                    [
